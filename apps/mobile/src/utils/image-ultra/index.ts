...
export { processImagePipeline, loadImageToCanvas, tileUpscaleCanvas } from './pipeline';
...
// Crop Scoring
export { tenengradScore, entropyScore, compositionScore, cut, clone } from './crop_scorer';
export type { Rect } from './crop_scorer';

// Auto Crop
export { proposeTrioCrops, bestOf3, clampRect } from './auto_crop';
export type { TrioMode } from './auto_crop';

// Horizon / Auto-Straighten
export { estimateHorizonAngle, rotateCanvas } from './horizon';

// Histogram / HDR Detection
export { computeHistogram, highlightClipFraction } from './histogram';
