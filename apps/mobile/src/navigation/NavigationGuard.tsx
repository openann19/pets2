      ...
      onReady={() => {
        ...
        if (initialRoute && navigationRef.isReady()) {
          ...
          if (!currentRoute || currentRoute.name === 'Home') {
            ...
            // Type assertion is safe here since initialRoute is validated as keyof RootStackParamList
            // navigate expects a string, and all RootStackParamList keys are strings
            navigationRef.navigate(initialRoute as string);
          }
        }
      }}
    >
