...
export const EnhancedShadows = {
  ...
  glow: {
    ...
    secondary: { shadowColor: COLORS.secondary[500], shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.3, shadowRadius: 8,  elevation: 8 } as ViewStyle,
    success:   { shadowColor: COLORS.success[500],   shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.3, shadowRadius: 8,  elevation: 8 } as ViewStyle,
    warning:   { shadowColor: COLORS.warning[500],   shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.3, shadowRadius: 8,  elevation: 8 } as ViewStyle,
    error:     { shadowColor: COLORS.error[500],     shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.3, shadowRadius: 8,  elevation: 8 } as ViewStyle,
  },
} as const;
...
export const EnhancedTypography = {
  effects: {
    shadow: {
      glow:   { textShadowColor: COLORS.primary[500],   textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 10 } as TextStyle,
      subtle: { textShadowColor: 'rgba(0,0,0,0.1)',     textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 4 } as TextStyle,
      strong: { textShadowColor: 'rgba(0,0,0,0.3)',     textShadowOffset: { width: 0, height: 4 }, textShadowRadius: 8 } as TextStyle,
    },
  },
...
export function GradientText(props: { children: string; variant?: keyof typeof DynamicColors['gradients']; textStyle?: TextStyle }) {
  const v = props.variant ?? 'primary';
  const g = DynamicColors.gradients[v];
  return (
    <MaskedView maskElement={<Text style={[{ backgroundColor: 'transparent' }, props.textStyle]}>{props.children}</Text>}>
      <LinearGradient colors={g.colors as string[]} start={g.start} end={g.end}>
        {/* Match text bounding box with some filler view */}
        <Text style={[{ opacity: 0 }, props.textStyle]}>{props.children}</Text>
      </LinearGradient>
    </MaskedView>
  );
}
...
export const Accessibility = {
  motion: {
    ...
    reducedMotionConfigs: {
      ...
      springs: { gentle: { tension: 50, friction: 5 }, standard: { tension: 100, friction: 8 } },
    },
  },
