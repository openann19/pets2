 ...
 */
export type TabNavigationProp<RouteName extends keyof BottomTabParamList> = BottomTabNavigationProp<
  BottomTabParamList,
  RouteName
>;
 ...
 */
export type NavigationProp<RouteName extends keyof RootStackParamList> = CompositeNavigationProp<
...
export interface TabOptions {
  tabBarLabel?: string;
  tabBarIcon?: (props: { color: string; size: number; focused: boolean }) => JSX.Element;
