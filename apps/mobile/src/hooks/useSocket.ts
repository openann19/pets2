...
import type { UserTypingEvent, NewMessageEvent, UserStatusEvent, OnlineUsersUpdate } from '@pawfectmatch/core';
...
// Emit helper
export function useSocketEmit(): (event: string, data?: Record<string, unknown>) => boolean {
