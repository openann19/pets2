      ...
      <View style={styles.inputGroup}>
        ...
        <View style={styles.optionsGrid}>
          {INTENT_OPTIONS.map((option) => (
            <TouchableOpacity
              key={option.value}
              style={[styles.optionButton, formData.intent === option.value && styles.selectedOption]}
      ...
      <View style={styles.inputGroup}>
        ...
        <View style={styles.tagsContainer}>
          {PERSONALITY_TAGS.slice(0, 12).map((tag) => (
            <TouchableOpacity
              key={tag}
              style={[styles.tagButton, formData.personalityTags.includes(tag) && styles.selectedTag]}
              testID="PersonalityStep-button-2" 
              accessibilityLabel="Interactive element" 
              accessibilityRole="button" 
