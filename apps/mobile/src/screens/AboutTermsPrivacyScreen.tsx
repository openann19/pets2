...
function AboutTermsPrivacyScreen({ navigation }: AboutTermsPrivacyScreenProps): React.JSX.Element {
  ...
  const handleDocumentOpen = useCallback(async (documentId: string) => {
    ...
    try {
      ...
      if (canOpen) {
        ...
        Alert.alert('Unable to Open', `Please visit ${url} in your browser to view this document.`);
      }
    } catch (error) {
      logger.error('Failed to open legal document', { error, documentId, url });
      Alert.alert('Error', `Unable to open document. Please visit ${url} in your browser.`);
    }
  }, []);
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          <TouchableOpacity
            ...
            testID="AboutTermsPrivacyScreen-button-2"
        ...
        >
          ...
          {/* Copyright */}
          <Text style={styles.copyright}>© 2024 PawfectMatch. All rights reserved.</Text>
        </ScrollView>
      </SafeAreaView>
    </View>
  );
