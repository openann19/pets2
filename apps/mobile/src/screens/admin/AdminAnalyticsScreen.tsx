...
export default function AdminAnalyticsScreen({ navigation }: AdminScreenProps<'AdminAnalytics'>): React.JSX.Element {
        ...
        {analytics ? <>
            ...
            <View style={styles.metricsGrid}>
              <View style={[styles.metricCard, { backgroundColor: colors.card }]}>
                <View style={styles.metricHeader}>
                  ...
                  <Text style={[styles.metricTitle, { color: colors.text }]}>Users</Text>
                </View>
                ...
                <View style={styles.metricTrend}>
                  ...
                  />
                  <Text style={[styles.metricTrendText, { color: getTrendColor(analytics.users.trend) }]}>
              ...
              <View style={[styles.metricCard, { backgroundColor: colors.card }]}>
                <View style={styles.metricHeader}>
                  ...
                  <Text style={[styles.metricTitle, { color: colors.text }]}>Matches</Text>
                </View>
                <Text style={[styles.metricValue, { color: colors.text }]}>
                ...
                <View style={styles.metricTrend}>
                  ...
                  />
                  <Text style={[styles.metricTrendText, { color: getTrendColor(analytics.matches.trend) }]}>
                    {analytics.matches.growth > 0 ? '+' : ''}{analytics.matches.growth}%
                  </Text>
                </View>
              </View>
              ...
              <View style={[styles.metricCard, { backgroundColor: colors.card }]}>
                <View style={styles.metricHeader}>
                  ...
                  <Text style={[styles.metricTitle, { color: colors.text }]}>Messages</Text>
                </View>
                <Text style={[styles.metricValue, { color: colors.text }]}>
                ...
                <View style={styles.metricTrend}>
                  ...
                  />
                  <Text style={[styles.metricTrendText, { color: getTrendColor(analytics.messages.trend) }]}>
                    {analytics.messages.growth > 0 ? '+' : ''}{analytics.messages.growth}%
                  </Text>
                </View>
              </View>
              ...
              <View style={[styles.metricCard, { backgroundColor: colors.card }]}>
                <View style={styles.metricHeader}>
                  ...
                  <Text style={[styles.metricTitle, { color: colors.text }]}>Revenue</Text>
                </View>
                <Text style={[styles.metricValue, { color: colors.text }]}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.engagementGrid}>
              ...
              <View style={[styles.engagementCard, { backgroundColor: colors.card }]}>
                <Text style={[styles.engagementLabel, { color: colors.textSecondary }]}>Session</Text>
                <Text style={[styles.engagementValue, { color: colors.text }]}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.revenueGrid}>
              <View style={[styles.revenueCard, { backgroundColor: colors.card }]}>
                <Text style={[styles.revenueLabel, { color: colors.textSecondary }]}>ARPU</Text>
                <Text style={[styles.revenueValue, { color: colors.text }]}>
                  {formatCurrency(analytics.revenue.averageRevenuePerUser)}
                </Text>
              </View>
              <View style={[styles.revenueCard, { backgroundColor: colors.card }]}>
                <Text style={[styles.revenueLabel, { color: colors.textSecondary }]}>Conversion</Text>
                <Text style={[styles.revenueValue, { color: colors.text }]}>
                  {analytics.revenue.conversionRate.toFixed(1)}%
                </Text>
              </View>
              <View style={[styles.revenueCard, { backgroundColor: colors.card }]}>
                <Text style={[styles.revenueLabel, { color: colors.textSecondary }]}>Churn</Text>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.securityGrid}>
              <View style={[styles.securityCard, { backgroundColor: colors.card }]}>
                ...
                <Text style={[styles.securityLabel, { color: colors.textSecondary }]}>Suspicious Logins</Text>
              ...
              <View style={[styles.securityCard, { backgroundColor: colors.card }]}>
                ...
                <Text style={[styles.securityLabel, { color: colors.textSecondary }]}>Blocked IPs</Text>
                <Text style={[styles.securityValue, { color: colors.text }]}>
              ...
              <View style={[styles.securityCard, { backgroundColor: colors.card }]}>
                ...
                <Text style={[styles.securityLabel, { color: colors.textSecondary }]}>Reported Content</Text>
                <Text style={[styles.securityValue, { color: colors.text }]}>
              ...
              <View style={[styles.securityCard, { backgroundColor: colors.card }]}>
                ...
                <Text style={[styles.securityLabel, { color: colors.textSecondary }]}>Banned Users</Text>
                <Text style={[styles.securityValue, { color: colors.text }]}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.performersGrid}>
              <View style={[styles.performersCard, { backgroundColor: colors.card }]}>
                <Text style={[styles.performersTitle, { color: colors.text }]}>Top Users</Text>
                {analytics.topPerformers.users.slice(0, 3).map((user, index) => (
                  <View key={user.id} style={styles.performerItem}>
                    <Text style={[styles.performerRank, { color: colors.textSecondary }]}>
                      #{index + 1}
                    </Text>
              ...
              <View style={[styles.performersCard, { backgroundColor: colors.card }]}>
                <Text style={[styles.performersTitle, { color: colors.text }]}>Top Pets</Text>
