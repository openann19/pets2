  ...
  return (
    <View style={[styles.healthCard, { backgroundColor: colors.surface }]}>
      <View style={styles.healthHeader}>
        ...
        <View
          style={[styles.statusBadge, { backgroundColor: getStatusColor(health.status, colors) }]}
        >
      ...
      <View style={styles.healthMetrics}>
        ...
        <View style={styles.metricRow}>
          ...
          <Text
            style={[styles.metricValue, { color: getStatusColor(health.database.status, colors) }]}
          >
