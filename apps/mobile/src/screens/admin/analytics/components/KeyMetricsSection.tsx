    ...
    <View style={styles.metricsGrid}>
      ...
      <View style={styles.metricCard}>
        <View style={styles.metricHeader}>
          <Ionicons name="people" size={20} color={colors.info ?? colors.primary ?? "#2563EB"} />
      ...
      <View style={styles.metricCard}>
        <View style={styles.metricHeader}>
          <Ionicons name="heart" size={20} color={colors.primary ?? colors.accent ?? "#2563EB"} />
      ...
      <View style={styles.metricCard}>
        <View style={styles.metricHeader}>
          <Ionicons name="chatbubble" size={20} color={colors.primary ?? colors.accent ?? "#2563EB"} />
