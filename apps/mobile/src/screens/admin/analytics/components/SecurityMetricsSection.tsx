...
export const SecurityMetricsSection: React.FC<SecurityMetricsSectionProps> = ({
  security,
}) => {
  ...
  return (
    <View style={styles.securityGrid}>
      <View style={[styles.securityCard, { backgroundColor: colors.surface }]}>
        ...
        <Text style={[styles.securityValue, { color: colors.onSurface }]}>{security.suspiciousLogins}</Text>
      </View>
      ...
      <View style={[styles.securityCard, { backgroundColor: colors.surface }]}>
        ...
        <Text style={[styles.securityValue, { color: colors.onSurface }]}>{security.blockedIPs}</Text>
      </View>
      ...
      <View style={[styles.securityCard, { backgroundColor: colors.surface }]}>
        ...
        <Text style={[styles.securityValue, { color: colors.onSurface }]}>{security.reportedContent}</Text>
      </View>
      ...
      <View style={[styles.securityCard, { backgroundColor: colors.surface }]}>
        ...
        <Text style={[styles.securityValue, { color: colors.onSurface }]}>{security.bannedUsers}</Text>
      </View>
    </View>
  );
};
