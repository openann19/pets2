    ...
    <View style={styles.stepContainer}>
      ...
      <View style={styles.inputGroup}>
        ...
        <View style={styles.optionsContainer}>
          {['First-time owner', '1-5 years', '5-10 years', '10+ years'].map((option) => (
            <TouchableOpacity
              key={option}
              style={[
                styles.optionButton,
      ...
      <View style={styles.inputGroup}>
        ...
        <View style={styles.optionsContainer}>
          {['Apartment', 'House with yard', 'House without yard', 'Farm/Rural'].map((option) => (
            <TouchableOpacity
              key={option}
              style={[
                styles.optionButton,
    ...
    <View style={styles.stepContainer}>
      ...
      {formData.references.map((ref, index) => (
        <View key={index} style={styles.referenceContainer}>
          <Text style={styles.referenceTitle}>Reference {index + 1} {index === 0 ? '*' : ''}</Text>
          <TextInput
            style={styles.input}
            value={ref.name}
  ...
  const renderCommitmentStep = () => (
    <View style={styles.stepContainer}>
      ...
      <View style={styles.agreementContainer}>
        ...
        <Text style={styles.agreementText}>• Cover all medical expenses and regular veterinary care</Text>
        <Text style={styles.agreementText}>• Allow a home visit if requested</Text>
        <Text style={styles.agreementText}>• Return the pet to the owner if unable to care for it</Text>
