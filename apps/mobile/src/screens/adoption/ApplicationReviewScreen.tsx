...
type ApplicationReviewScreenProps = NativeStackScreenProps<AdoptionStackParamList, 'ApplicationReview'>;
          ...
          <BlurView intensity={20} style={styles.statusCard}>
            <View style={styles.statusHeader}>
              <View style={styles.petInfo}>
                <Image source={{ uri: application.petPhoto }} style={styles.petImage} />
