...
function SafetyCenterScreen(): React.ReactElement {
  ...
  const { emergencyMode, safetyOptions, toggleEmergencyMode, handleSafetyOption, handleGoBack } =
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          <TouchableOpacity
            ...
            testID="SafetyCenterScreen-button-2"
        ...
        >
          ...
          <TouchableOpacity
            ...
            testID="SafetyCenterScreen-button-1"
