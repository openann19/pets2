...
function AdvancedFiltersScreen({ navigation }: AdvancedFiltersScreenProps): JSX.Element {
  const [filters, setFilters] = useState<FilterOption[]>([
    ...
    // Energy Level
    { id: 'low_energy', label: 'Low Energy Pets', value: false, category: 'energy' },
    { id: 'high_energy', label: 'High Energy Pets', value: true, category: 'energy' },

    // Special Needs
    { id: 'special_needs', label: 'Include Special Needs Pets', value: true, category: 'special' },
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          <BlurView intensity={10} style={styles.infoCard}>
            ...
            <Text style={styles.infoText}>
              Advanced filters help you find pets that match your specific preferences and lifestyle.
            </Text>
          </BlurView>
