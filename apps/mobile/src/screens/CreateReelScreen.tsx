...
const makeStyles = (theme: any) =>
  StyleSheet.create({
    ...
    headerText: { fontSize: 24, fontWeight: 'bold', color: theme.colors.text, marginBottom: 12 },
    ...
    renderProgressText: { color: theme.colors.text, fontSize: 14 },
    ...
    ghostBtnText: { color: theme.colors.text, fontWeight: '700', fontSize: 16 },
    ...
    clipText: { fontSize: 12, color: theme.colors.text, textAlign: 'center' },
