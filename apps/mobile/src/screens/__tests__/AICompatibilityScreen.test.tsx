...
describe('AICompatibilityScreen', () => {
  ...
  const renderComponent = (routeParams?: any) => {
    ...
    return render(<AICompatibilityScreen navigation={mockNavigation} route={mockRoute} />);
  };
  ...
  describe('Compatibility Analysis', () => {
    ...
    it('calls API with correct parameters when analyzing compatibility', async () => {
      ...
      (api.ai.analyzeCompatibility as jest.Mock).mockImplementation(mockAnalyzeCompatibility);
    ...
    it('displays compatibility results when API call succeeds', async () => {
      ...
      (api.ai.analyzeCompatibility as jest.Mock).mockResolvedValue(mockCompatibilityResult);
  ...
  describe('Error Handling', () => {
    ...
    it('handles network timeout gracefully', async () => {
      ...
      (api.ai.analyzeCompatibility as jest.Mock).mockRejectedValue(timeoutError);
