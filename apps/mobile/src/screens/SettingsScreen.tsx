...
export default function SettingsScreen({ navigation }: SettingsScreenProps) {
  ...
  const handleNavigation = (id: string) => {
    switch (id) {
      ...
      case 'feedback':
      case 'about':
        Alert.alert('Coming Soon', `${id.charAt(0).toUpperCase() + id.slice(1)} feature is coming soon!`);
        break;
      default:
  ...
  const renderSection = (title: string, items: SettingItem[], category?: 'notifications' | 'preferences') => (
