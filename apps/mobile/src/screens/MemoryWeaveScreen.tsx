          ...
          <TouchableOpacity
            ...
            style={StyleSheet.flatten([
              styles.pathDot,
              {
                ...
                top: point.y - 6,
                backgroundColor:
                  index === currentIndex ? theme.colors.primary : theme.colors.onSurface,
  ...
  return (
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.header}>
        <Animated.View style={StyleSheet.flatten([styles.headerContent, { opacity: fadeAnim }])}>
          <TouchableOpacity
      ...
      {/* Connection Path */}
      <Animated.View style={StyleSheet.flatten([styles.pathContainer, { opacity: fadeAnim }])}>
        {renderConnectionPath()}
      </Animated.View>

      {/* Memory Counter */}
      <Animated.View style={StyleSheet.flatten([styles.counterContainer, { opacity: fadeAnim }])}>
        <BlurView
          intensity={20}
