  ...
  const handlePress = useCallback((): void => {
    ...
    if (reduceMotion || !isEnabled) {
      ...
      scale.value = withSequence(
        withSpring(buttonConfig.pressScale, { damping: buttonConfig.springDamping, stiffness: buttonConfig.springStiffness }),
        withSpring(buttonConfig.bounceScale, { damping: buttonConfig.springDamping * 0.8, stiffness: buttonConfig.springStiffness * 0.7 }),
        withSpring(1, { damping: buttonConfig.springDamping * 1.2, stiffness: buttonConfig.springStiffness * 0.8 })
      );
    ...
    onPress();
  }, [disabled, loading, onPress, scale, rotation, shimmer, triggerHaptic, reduceMotion, isEnabled, buttonConfig]);
