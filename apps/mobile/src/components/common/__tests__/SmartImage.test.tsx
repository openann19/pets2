...
jest.mock("react-native-reanimated", () => {
  ...
  return {
    ...
    Image: React.forwardRef((props: any, ref: any) => <Image {...props} ref={ref} />),
...
describe("SmartImage", () => {
  ...
  it("renders with preview blur effect", () => {
    const { container } = render(
      <SmartImage source={{ uri: mockUri }} previewBlurRadius={16} />,
    );
    expect(container).toBeTruthy();
  });
  ...
  it("applies custom blur radius", () => {
    ...
    blurRadii.forEach((radius) => {
      const { container } = render(
        <SmartImage source={{ uri: mockUri }} previewBlurRadius={radius} />,
      );
      expect(container).toBeTruthy();
    });
  });
  ...
  it("handles onLoad event", () => {
    ...
    const { UNSAFE_getByType } = render(
      <SmartImage source={{ uri: mockUri }} onLoad={onLoad} />,
    );
  ...
  it("applies style prop correctly", () => {
    ...
    const { container } = render(
      <SmartImage source={{ uri: mockUri }} style={customStyle} />,
    );
  ...
  it("supports resizeMode prop", () => {
    const { container } = render(
      <SmartImage source={{ uri: mockUri }} resizeMode="cover" />,
    );
    expect(container).toBeTruthy();
  });
  ...
  it("handles different resizeMode values", () => {
    ...
    modes.forEach((mode) => {
      const { container } = render(
        <SmartImage source={{ uri: mockUri }} resizeMode={mode as any} />,
      );
      expect(container).toBeTruthy();
    });
  });
  ...
  it("works with local image sources", () => {
    const { container } = render(
      <SmartImage source={require("../../../../assets/icon.png")} />,
    );
    expect(container).toBeTruthy();
  });
  ...
  it("shows placeholder until loaded", async () => {
    const { container } = render(
      <SmartImage source={{ uri: mockUri }} previewBlurRadius={32} />,
    );
  ...
  it("handles multiple images in sequence", () => {
    ...
    uris.forEach((uri, index) => {
      const { container } = render(
        <SmartImage key={index} source={{ uri }} />,
      );
      expect(container).toBeTruthy();
    });
  });
  ...
  it("applies custom transition duration", () => {
    const { container } = render(
      <SmartImage source={{ uri: mockUri }} style={{ opacity: 0.5 }} />,
    );
    expect(container).toBeTruthy();
  });
  ...
  it("supports tintColor prop", () => {
    const { container } = render(
      <SmartImage source={{ uri: mockUri }} tintColor="#FF0000" />,
    );
    expect(container).toBeTruthy();
  });
  ...
  it("handles priority loading", () => {
    const { container } = render(
      <SmartImage source={{ uri: mockUri, priority: "high" }} />,
    );
    expect(container).toBeTruthy();
  });
  ...
  it("works with testID", () => {
    const { getByTestId } = render(
      <SmartImage source={{ uri: mockUri }} testID="test-image" />,
    );
