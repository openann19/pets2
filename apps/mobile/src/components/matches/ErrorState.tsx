...
export function ErrorState({ onRetry }: ErrorStateProps): React.JSX.Element {
  return (
    <View style={styles.container} accessibilityLabel="Error loading matches">
        <Image source={require('../../../assets/error-pet.png')} style={styles.image} />
        <Text style={styles.title}>Oops! Something went wrong.</Text>
        <Text style={styles.subtitle}>We couldn't load your matches. Please try again.</Text>
        <TouchableOpacity style={styles.button} onPress={onRetry} accessibilityLabel="Retry loading matches">
