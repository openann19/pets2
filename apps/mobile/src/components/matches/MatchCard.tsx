...
function MatchCardBase({ match, onPress, onUnmatch, onArchive, onReport }: MatchCardProps): JSX.Element {
    ...
    const handleReport = () => {
        Alert.alert(
            'Report Match',
            `Report this match with ${displayPet.name}?`,
            [
            ...
            >
                <LinearGradient colors={["#fceabb", "#f8b500", "#ec4899", "#a21caf"]} style={styles.gradient}>
                    ...
                    <View style={styles.info}>
                        ...
                        <Text style={styles.meta}>{displayPet.breed}, {displayPet.age} years old</Text>
