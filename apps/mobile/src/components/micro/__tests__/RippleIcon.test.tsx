...
describe("RippleIcon", () => {
  ...
  it("applies custom size", () => {
    const { container } = render(<RippleIcon trigger={0} size={48} />);
    expect(container).toBeTruthy();
  });
  ...
  it("applies custom stroke", () => {
    const { container } = render(<RippleIcon trigger={0} stroke={3} />);
    expect(container).toBeTruthy();
  });
  ...
  it("applies custom color", () => {
    const { container } = render(
      <RippleIcon trigger={0} color="rgba(255,0,0,0.5)" />,
    );
    expect(container).toBeTruthy();
  });
  ...
  it("handles size variations", () => {
    ...
    sizes.forEach((size) => {
      const { container } = render(<RippleIcon trigger={0} size={size} />);
      expect(container).toBeTruthy();
    });
  });
  ...
  it("handles stroke variations", () => {
    ...
    strokes.forEach((stroke) => {
      const { container } = render(<RippleIcon trigger={0} stroke={stroke} />);
      expect(container).toBeTruthy();
    });
  });
  ...
  it("handles color variations", () => {
    ...
    colors.forEach((color) => {
      const { container } = render(<RippleIcon trigger={0} color={color} />);
      expect(container).toBeTruthy();
    });
  });
