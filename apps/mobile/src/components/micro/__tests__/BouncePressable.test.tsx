...
describe("BouncePressable", () => {
  ...
  it("does not provide haptic feedback when disabled", () => {
    ...
    const { getByText } = render(
      <BouncePressable onPress={onPress} haptics={false}>
        <Text>Press Me</Text>
      </BouncePressable>,
    );
  ...
  it("calls onPressIn handler", () => {
    ...
    const { getByText } = render(
      <BouncePressable onPress={onPress} onPressIn={onPressIn}>
        <Text>Press Me</Text>
      </BouncePressable>,
    );
  ...
  it("calls onPressOut handler", () => {
    ...
    const { getByText } = render(
      <BouncePressable onPress={onPress} onPressOut={onPressOut}>
        <Text>Press Me</Text>
      </BouncePressable>,
    );
  ...
  it("applies custom scale values", () => {
    ...
    const { getByText } = render(
      <BouncePressable onPress={onPress} scaleFrom={0.9} scaleTo={1.1}>
        <Text>Press Me</Text>
      </BouncePressable>,
    );
  ...
  it("handles disabled state", () => {
    ...
    const { getByText } = render(
      <BouncePressable onPress={onPress} disabled>
        <Text>Press Me</Text>
      </BouncePressable>,
    );
  ...
  it("applies custom accessibility props", () => {
    ...
    const { getByRole } = render(
      <BouncePressable onPress={onPress} accessibilityLabel="Custom Button" accessibilityRole="button">
        <Text>Press Me</Text>
      </BouncePressable>,
    );
  ...
  it("supports all PressableProps", () => {
    ...
    const { getByText } = render(
      <BouncePressable onPress={onPress} onLongPress={onLongPress}>
        <Text>Press Me</Text>
      </BouncePressable>,
    );
