...
const RippleIcon = memo(function RippleIcon({ size = 36, stroke = 2, trigger, color = "rgba(236,72,153,0.35)" }: Props) {
  const t = useSharedValue(0);
  useEffect(() => { t.value = 0; t.value = withTiming(1, { duration: 450 }); }, [trigger]);
