...
export const AdvancedPetFilters: React.FC<AdvancedPetFiltersProps> = ({ value, onChange, onReset, onApply }) => {
    ...
    return (
        <Animated.View style={animatedStyle}>
            <LinearGradient colors={["#fceabb", "#f8b500", "#ec4899", "#a21caf"]} style={styles.container}>
