...
function ModernText({
  ...
  // Get text color
  const textColor = Theme.semantic.text[color];
  ...
  if (gradient || gradientColors) {
    ...
    const colors = gradientColors || gradientConfig?.colors || [Theme.colors.primary[500], Theme.colors.primary[400]];
...
// === SEMANTIC COMPONENTS ===
export function Heading1(props: Omit<ModernTextProps, 'variant'>): React.JSX.Element {
...
export const BodyLarge: React.FC<Omit<ModernTextProps, 'variant'>> = (props) => (
  <ModernText variant="bodyLarge" {...props} />
);

export const BodySmall: React.FC<Omit<ModernTextProps, 'variant'>> = (props) => (
...
export const ButtonText: React.FC<Omit<ModernTextProps, 'variant'>> = (props) => (
...
export const GradientHeading: React.FC<Omit<ModernTextProps, 'gradient'>> = (props) => (
  <ModernText variant="h1" gradient="primary" {...props} />
);

export const GradientText: React.FC<Omit<ModernTextProps, 'gradient'>> = (props) => (
  <ModernText gradient="primary" {...props} />
);

export const HolographicText: React.FC<Omit<ModernTextProps, 'gradient'>> = (props) => (
  <ModernText gradient="holographic" {...props} />
);

// === ANIMATED TEXT COMPONENTS ===
export const AnimatedHeading: React.FC<Omit<ModernTextProps, 'animated'>> = (props) => (
  <ModernText variant="h1" animated={true} {...props} />
);

export const AnimatedText: React.FC<Omit<ModernTextProps, 'animated'>> = (props) => (
