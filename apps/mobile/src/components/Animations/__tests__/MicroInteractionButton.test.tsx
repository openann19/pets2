...
jest.mock('react-native-reanimated', () => {
  ...
  return {
    ...
    interpolate: jest.fn((value: unknown) => {
...
describe('MicroInteractionButton', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    (useReduceMotion as jest.MockedFunction<typeof useReduceMotion>).mockReturnValue(false);
    (useSoundEffect as jest.MockedFunction<typeof useSoundEffect>).mockReturnValue({
      play: mockPlaySound,
      enabled: true,
      setEnabled: jest.fn(),
    });
    (useHapticFeedback as jest.MockedFunction<typeof useHapticFeedback>).mockReturnValue({
      triggerHaptic: mockTriggerHaptic,
      triggerSuccess: mockTriggerSuccess,
      triggerWarning: mockTriggerWarning,
      triggerError: mockTriggerError,
    });
    (Haptics.impactAsync as jest.MockedFunction<typeof Haptics.impactAsync>).mockResolvedValue(undefined);
  });
  ...
  describe('Accessibility', () => {
    ...
    it('should respect reduced motion', () => {
      (useReduceMotion as jest.MockedFunction<typeof useReduceMotion>).mockReturnValue(true);
