...
export default function DemoChatVideoPage() {
  ...
  const handleLogin = () => {
    ...
    const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2OGRiMjczNzgwZDllNGJiODlkZmYyNzkiLCJpYXQiOjE3NTkxOTI4ODcsImV4cCI6MTc1OTE5Mzc4N30.CpmDRqT6O6l-Nzz-cFnDnAFCVxwgfO-KRleAmUeRNIg';
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-4">
            🎉 Chat & Video Call Demo
          </h1>
          <p className="text-white/70 mb-6">
            Test the premium chat and video calling features
          </p>
          <PremiumButton
            variant="secondary"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Chat Demo */}
          <PremiumCard className="p-8 text-center" hover tilt>
            <ChatBubbleLeftRightIcon className="w-20 h-20 mx-auto text-white mb-6" />
            <h3 className="text-2xl font-bold text-white mb-4">
              Chat Demo
            </h3>
            <p className="text-white/70 mb-6">
              Experience real-time messaging with premium features like typing indicators, read receipts, and emoji reactions
            </p>
            <PremiumButton
              size="lg"
