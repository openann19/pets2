  ...
  const steps = [
    {
      ...
      description: "No signup required! Browse through adorable pets and see their photos, details, and owner information.",
      icon: EyeIcon,
      color: "text-blue-500",
      bgColor: "bg-blue-50",
      action: "Browse Now",
    ...
    },
    {
      number: 2,
      title: "Like or Chat",
      description: "When you find a pet you love, click Like or Chat. We'll ask you to sign up at this point.",
      icon: HeartIcon,
      color: "text-red-500",
      bgColor: "bg-red-50",
      action: "Try It",
    ...
    },
    {
      number: 3,
      title: "Quick Signup",
      description: "Simple signup process. Just email and password. No lengthy forms or verification required.",
      icon: UserIcon,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {steps.map((step, index) => (
            <div key={step.number}>
              <PremiumCard className="h-full p-6 text-center" variant="glass">
                <div className={`w-16 h-16 bg-white/10 border border-white/10 rounded-full flex items-center justify-center mx-auto mb-4`}>
        ...
        {/* Benefits */}
        <div className="mb-12">
          <PremiumCard className="p-8" variant="glass">
        ...
        {/* Technical Details */}
        <div className="mt-12">
          <PremiumCard className="p-6" variant="glass">
