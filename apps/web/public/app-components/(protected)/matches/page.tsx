      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {matches && matches.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">Start swiping to find your perfect pet matches!</p>
            <Link
              href="/swipe"
              className="inline-block px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg font-semibold hover:from-pink-600 hover:to-purple-700 transition-colors"
            >
              Start Swiping
            </Link>
          </div>
