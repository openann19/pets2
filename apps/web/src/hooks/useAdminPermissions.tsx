...
export function useAdminPermissions() {
     ...
     */
    const hasAnyPermission = useCallback((permissionList) => permissionList.some((permission) => hasPermission(permission)), [hasPermission]);
    /**
     * Check if user has ALL of the specified permissions
     */
    const hasAllPermissions = useCallback((permissionList) => permissionList.every((permission) => hasPermission(permission)), [hasPermission]);
    /**
...
export const PermissionGuard = ({ permission, requireAll = false, fallback = null, children, }) => {
    ...
    if (permissions.length === 1) {
        hasAccess = permissions?.[0] ? hasPermission(permissions[0]) : false;
    }
    else if (requireAll) {
...
export const RoleGuard = ({ role, fallback = null, children }) => {
...
//# sourceMappingURL=useAdminPermissions.jsx.map
//# sourceMappingURL=useAdminPermissions.jsx.map