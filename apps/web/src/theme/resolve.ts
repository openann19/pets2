/**
 * 🎨 THEME RESOLVER
 * Converts base theme structure to unified AppTheme type
 * Matches mobile app resolve.ts structure exactly
 */
...
export function resolveTheme(base: typeof BaseLight | typeof BaseDark): AppTheme {
  ...
  return {
    ...
    colors: {
      ...
      overlay: `${bgPrimary}80`, // semi-transparent overlay (hex + opacity)
    ...
    spacing: {
      ...
      'lg': base.spacing.lg,
      'xl': base.spacing.xl,
      '2xl': base.spacing['2xl'] ?? base.spacing.xl * 1.25,
      '3xl': base.spacing['3xl'] ?? base.spacing.xl * 1.5,
      '4xl': base.spacing['4xl'] ?? base.spacing.xl * 2,
    },
    shadows: {
      elevation1: base.shadows.depth.sm,
      elevation2: base.shadows.depth.md,
      glass: base.shadows.depth.lg,
    },
    blur: {
      sm: 8,
      md: 16,
