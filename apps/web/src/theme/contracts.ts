/**
 * 🎨 THEME CONTRACTS
 * Type definitions matching mobile app theme contracts
 * Single source of truth for theme types across platforms
 */
...
export type Elevation = {
  elevation1: string | object;
  elevation2: string | object;
  glass: string | object;
};
