...
adminApiKeySchema.statics.generateApiKey = async function(name, userId, permissions = {}) {
...
module.exports = mongoose.models.AdminApiKey || mongoose.model('AdminApiKey', adminApiKeySchema);
