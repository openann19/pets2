...
class EmailUtils {
   ...
   */
  generateEmailOptions(templateName: string, data: any): {
    from: string;
    to: string;
    subject: string;
    html: string;
    ...
    const templateMap: Record<string, (data: any) => EmailTemplate> = {
      'welcome': (data) => emailTemplates.welcome(data),
      'matchFound': (data) => emailTemplates.matchFound(data),
      'passwordReset': (data) => emailTemplates.passwordReset(data),
      'emailVerification': (data) => emailTemplates.emailVerification(data),
      'premiumUpgrade': (data) => emailTemplates.premiumUpgrade(data),
    };
   ...
   */
  previewTemplate(templateName: string, data: any): EmailTemplate {
    const emailTemplates = new EmailTemplates();
    const templateMap: Record<string, (data: any) => EmailTemplate> = {
      'welcome': (data) => emailTemplates.welcome(data),
      'matchFound': (data) => emailTemplates.matchFound(data),
