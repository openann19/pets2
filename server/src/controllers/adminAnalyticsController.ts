 ...
 * Get pet statistics
 */
const getPetStats = async (startDate) => {
 ...
 */
const getMatchStats = async (startDate) => {
 ...
 */
const getMessageStats = async (startDate) => {
 ...
 */
const getTimeSeries = async (startDate, timeRange) => {
