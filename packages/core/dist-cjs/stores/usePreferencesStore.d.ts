 ...
 */
export declare const _usePreferencesStore: import("zustand").UseBoundStore<Omit<Omit<import("zustand").StoreApi<PreferencesState>, "persist"> & {
    persist: {
        setOptions: (options: Partial<import("zustand/middleware").PersistOptions<PreferencesState, {
            updateDiscoveryPreferences: (preferences: Partial<{
                maxDistance: number;
                ageRange: {
                    min: number;
                    max: number;
            ...
            updateAppearanceSettings: (settings: Partial<{
                theme: "light" | "dark" | "system";
                reducedMotion: boolean;
                fontSize: "small" | "medium" | "large";
                highContrast: boolean;
        ...
        getOptions: () => Partial<import("zustand/middleware").PersistOptions<PreferencesState, {
            updateDiscoveryPreferences: (preferences: Partial<{
                maxDistance: number;
                ageRange: {
                    min: number;
