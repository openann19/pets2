...
exports._bioGeneratorService = exports.BioGeneratorService = void 0;
const gemini_client_1 = require("./gemini-client");
class BioGeneratorService {
    /**
     * Generate pet bio using AI
     */
    async generateBio(request) {
     ...
     */
    buildPrompt(request) {
        const { petName, species, breed, age, personality = [], keywords = [], tone = 'friendly', length = 'medium' } = request;
        const lengthMap = {
            short: '50-75 words',
        ...
        if (age != null && !isNaN(age) && age > 0)
            prompt += `Age: ${String(age)} years old\n`;
        if (personality.length > 0)
            prompt += `Personality: ${personality.join(', ')}\n`;
    ...
    extractTags(response) {
        ...
        if (tagsSection == null || tagsSection.length === 0)
            return [];
        // Extract hashtags
